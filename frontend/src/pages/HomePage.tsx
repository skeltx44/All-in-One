    ...
    <div className="px-5 pt-6">
      ...
      <section className="mt-4">
        ...
        <div className="grid w-full grid-cols-2 gap-3">
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-lime-100 shadow-inner">
          ...
          <button
            ...
            className="flex h-[100px] flex-col justify-between rounded-[22px] bg-white p-3.5 text-left shadow-[0_6px_16px_rgba(73,105,140,0.12)] active:scale-[0.98]"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-sky-100 shadow-inner">
